...
function cafe_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Cafes', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Cafe', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Cafes', 'text_domain' ),
		'name_admin_bar'        => __( 'Cafe', 'text_domain' ),
		'archives'              => __( 'Cafe Archives', 'text_domain' ),
		'attributes'            => __( 'Cafe Attributes', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Cafe Description', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => false,
